...
namespace IVSoftware.Web.Migrations
{
    ...
    [Migration("20210311201031_QuotationCancelationResponsefieldAndQuotationAcceptedStatusAddedByscript")]
    partial class QuotationCancelationResponsefieldAndQuotationAcceptedStatusAddedByscript
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.EquipmentPurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<Guid?>("AnalystPersonId")
                        .IsRequired()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("HourlyIntensity")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NetworkCompatibility")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("RequestStatusDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("RequiresLearning")
                        .HasColumnType("bit");

                    b.Property<Guid?>("ResponsePersonId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EquipmentPurchaseRequests");
                });
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.IncentivesIntoServiceQuotationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<float>("IncentiveCurrentValue")
                        .HasColumnType("real");
                    ...
                    b.ToTable("IncentivesIntoServiceQuotationRequest");
                });
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.LaboratoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.QuestionEvaluation", b =>
                {
                    ...
                    b.HasKey("QuestionId", "EvaluationId");
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.QuotationRequest", b =>
                {
                    ...
                    b.Property<string>("CancelationResponse")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("ServicesReportTime")
                        .HasColumnType("int");

                    b.Property<float>("ServicesTotal")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.SamplingType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.ServiceModel", b =>
                {
                    ...
                    b.Property<double>("AnalizeBefore")
                        .HasColumnType("float");
                    ...
                    b.Property<Guid?>("BackupAnalystId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PreservativesTheirConcentrationQuantity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("QuantificationLimit")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReceptionDays")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double>("RegulatoryStorageTime")
                        .HasColumnType("float");

                    b.Property<string>("RelatedProtocol")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ReportDeliveryTime")
                        .HasColumnType("int");

                    b.Property<string>("SamplingCaptureDescription")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("TypeOfSamplingId")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("VolumeEstablishedByLaboratory")
                        .HasColumnType("float");

                    b.Property<string>("WashingCleaningConditionsForContainer")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.StorageContainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StorageContainer");
                });

            modelBuilder.Entity("IVSoftware.Data.Models.Supervision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("SupervisedPersonId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SupervisedPersonId");

                    b.ToTable("Supervision");
                });

            modelBuilder.Entity("IVSoftware.Data.Models.SupervisionDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("SupervisedActivity")
                        .IsRequired()
                        .HasMaxLength(3000)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.SupervisionFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.EquipmentPurchaseRequest", b =>
                {
                    b.HasOne("IVSoftware.Data.Models.Person", "ResponsibleAnalyst")
                        .WithMany()
                        .HasForeignKey("AnalystPersonId")
                    ...
                    b.Navigation("StatusChangePerson");
                });
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.QuestionEvaluation", b =>
                {
                    b.HasOne("IVSoftware.Data.Models.Evaluation", "Evaluation")
                        .WithMany("QuestionsEvaluation")
                        .HasForeignKey("EvaluationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IVSoftware.Data.Models.EvaluationQuestionBank", "Question")
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.ServiceModel", b =>
                {
                    ...
                    b.HasOne("IVSoftware.Data.Models.StorageContainer", "StorageContainer")
                        .WithMany()
                        .HasForeignKey("StorageContainerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IVSoftware.Data.Models.SamplingType", "TypeOfSampling")
                        .WithMany()
            ...
            modelBuilder.Entity("IVSoftware.Data.Models.Supervision", b =>
                {
                    b.HasOne("IVSoftware.Data.Models.Person", "SupervisedBy")
                        .WithMany("SupervisionsByMe")
                        .HasForeignKey("SupervisedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IVSoftware.Data.Models.Person", "SupervisedPerson")
                        .WithMany("Supervisions")
                        .HasForeignKey("SupervisedPersonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("SupervisedBy");

                    b.Navigation("SupervisedPerson");
                });

            modelBuilder.Entity("IVSoftware.Data.Models.SupervisionDetail", b =>
                {
                    b.HasOne("IVSoftware.Data.Models.Supervision", "Supervision")
                        .WithMany("Details")
